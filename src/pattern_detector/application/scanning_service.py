"""Application scanning service orchestrating Gleam pattern detection."""
...
class ScanningService(ScannerPort):
    """Coordinates discovering, parsing, rule evaluation, and exporting for Gleam codebases."""
