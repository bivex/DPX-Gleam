"""Console Rich Formatter for Gleam pattern detection findings."""
...
class ConsoleReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        ...
        # Header Banner
        header = Panel.fit(
            f"[bold white]⭐ DPX-Gleam: Type-Safe OTP Actors, Algebraic Data Types, Railway Monads & GoF 23 (Gleam 1.x)[/bold white]\n"
        ...
        console.print(table)
        console.print("\n[bold]📋 Identified Architectural Patterns & BEAM Concurrency Signals:[/bold]\n")
