"""JSON, Markdown, SARIF formatters & persistence repositories for Gleam."""
...
class MarkdownReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        lines = [
            f"# ⭐ DPX-Gleam: Architectural Context & Pattern Report",
            f"",
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "DPX-Gleam",
                            "informationUri": "https://github.com/bivex/DPX-Gleam",
                            "version": "0.1.0",
                        }
                    },
                    "results": results,
