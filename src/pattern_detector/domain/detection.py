"""Detection models and aggregate reporting for Gleam."""
...
@dataclass
class Detection:
    """Individual pattern detection or hazard finding in Gleam."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "type", "fn", "module", "actor", "pipeline"
    ...
    def summary(self) -> str:
        ...
        return f"Gleam architectural pattern: {self.pattern_type.value}"
...
class DetectionReport:
    """Aggregate scan result containing all detections across a Gleam project."""
