"""Domain service evaluating pattern detection rules on Gleam CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Gleam CodeModel with confidence thresholding and filtering."""
